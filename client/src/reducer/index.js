...
function rootReducer(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case GET_COUNTRIES:
            ...
            case GET_COUNTRIES_FOR_LANDING:
                return {
                    ...state,
                    countriesForLanding: action.payload, // En el estado countries que inicialmente está definido como un arreglo vacío mandar todo lo que envíe la acción GET_CONTRIES.
                    filterCountriesForLanding: action.payload
                }
        ...
        case ORDER_COUNTRY_BY_NAME:
            console.log('Reducer: state.filterCountries: ', state.filterCountries);
